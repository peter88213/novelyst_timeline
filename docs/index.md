...
[Download the latest release (version 2.0.4)](https://raw.githubusercontent.com/peter88213/novelyst_timeline/main/dist/novelyst_timeline_v2.0.4.zip)

- Unzip the downloaded zipfile "novelyst_timeline_v2.0.4.zip" into a new folder.

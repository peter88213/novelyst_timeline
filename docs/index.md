...
[Download the latest release (version 2.1.0)](https://raw.githubusercontent.com/peter88213/novelyst_timeline/main/dist/novelyst_timeline_v2.1.0.zip)

- Unzip the downloaded zipfile "novelyst_timeline_v2.1.0.zip" into a new folder.
